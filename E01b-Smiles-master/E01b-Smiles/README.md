...
-------------------------------------
WHAT I DID: 
Manually altered coordinates of each piece to accurately represent smile.png, each X and Y, whether deducing true coordinates or + and - from derived location. As well discovered that line 15 through 18 main4 change the number and location of overlapping layers. Finally attempted to describe the use of each line in main5.
-----------------------------------
