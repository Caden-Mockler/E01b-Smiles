...
face_x,face_y = (400,350)
smile_x,smile_y = (face_x + 0,face_y - 15)
eye1_x,eye1_y = (face_x - 35,face_y + 20) 
eye2_x,eye2_y = (face_x + 35,face_y + 20)
catch1_x,catch1_y = (face_x - 29,face_y + 33) 
catch2_x,catch2_y = (face_x + 40,face_y + 33) 
...
arcade.draw_ellipse_filled(eye1_x,eye1_y,35,55,open_color.black)
arcade.draw_ellipse_filled(eye2_x,eye2_y,35,55,open_color.black)
